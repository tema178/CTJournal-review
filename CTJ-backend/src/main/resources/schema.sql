...
create table workouts (id bigint generated by default as identity, comment varchar(255), date timestamp(6), efforts tinyint not null, end_time bigint not null, start_time bigint not null, location_id bigint, username varchar(255) not null, primary key (id));
